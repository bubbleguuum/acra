...
public class ACRAConfiguration implements ReportsCrashes {
	...
	private LogCollector mApplicationLogCollector = null;
	...
	/**
	 * 
	 * @param applicationLogCollector
	 *            A log collector, to be used with {@link ReportField#APPLICATION_LOG}
	 */
	public void setApplicationLogCollector(LogCollector applicationLogCollector) {
		mApplicationLogCollector = applicationLogCollector;
	}
	...
	public LogCollector applicationLogCollector() {
		return mApplicationLogCollector;
	}
